...
# Add the snpe directory to sys.path so libsnpehelper.so can be found
_snpe_dir = os.path.dirname(os.path.abspath(__file__))
if _snpe_dir not in sys.path:
    sys.path.insert(0, _snpe_dir)
